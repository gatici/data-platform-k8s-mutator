...
class GenWebhookCertsConfig:
    ...
    image_pull_policy: str = (
        ""  # If set, it is added to the webhook container for local images
    )
...
webhooks:
  - name: sysctl-webhook.{config.namespace}.local
    ...
    sideEffects: None
    # If the webhook fails, statefulsets/deployments/daemonsets will not be created.
    failurePolicy: Fail
...
"""
    ...
    # chr(10) = newline. avoid '\n' in f-string expression (invalid on Python 3.10)
    image_pull_line = (
        (f"          imagePullPolicy: {config.image_pull_policy}" + chr(10))
